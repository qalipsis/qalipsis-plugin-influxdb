# <a src="https://qalipsis.io"><img src="http://assets.qalipsis.io/qalipsis-logo.png" style="height:60px;width:60px;position:relative;top:18px;margin-right:20px;"/>QALIPSIS for InfluxDB</a>

![CI](https://github.com/qalipsis/qalipsis-plugin-cassandra/actions/workflows/gradle-master.yml/badge.svg)
...
The QALIPSIS plugin for InfluxDB is distributed under the Apache License 2.0, the terms can be
read [here](./LICENSE).
